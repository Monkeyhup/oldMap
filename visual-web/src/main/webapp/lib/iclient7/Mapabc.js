...
SuperMap.Layer.MapABC = SuperMap.Class(SuperMap.CanvasLayer, {
    ...
    url: "http://emap${a}.mapabc.com/mapabc/maptile?v=w2.61&&x=${x}&y=${y}&z=${z}",
     ...
     //url:"http://10.6.133.130/maptile/maptile?x=${x}&y=${y}&z=${z}",

    //url: "http://emap${a}.mapabc.com/mapabc/maptile?lang=zh_cn&size=1&scale=1&style=6&x=${x}&y=${y}&z=${z}",
    //lang=zh_cn&size=1&scale=1&style=6&x=6747&y=3101&z=13 HTTP/1.1
    //x=6746&y=3098&z=13
